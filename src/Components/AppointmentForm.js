...
import axios from "axios"; // Thêm import thư viện axios
...
function AppointmentForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Reset form fields và errors sau khi gửi thành công
      setPatientName("");
      setPatientNumber("");
      ...
      toast.success("Appointment Scheduled !", {
        ...
        onOpen: () => {
          setIsSubmitted(true);
          navigate("/home"); // Chuyển hướng về trang home sau khi đăng ký thành công
        },
